...
const Sidebar = () => {
  ...
  const sidebarLinks = [
    { name: "Add Items", to: "/add", icon: dashboardicon },
    { name: "List Item", to: "/list", icon: overviewicon },
    { name: "Orders", to: "/orders", icon: chaticon },
  ];
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `flex items-center py-3 px-4 gap-3 ${
              isActive
                ? "border-r-4 md:border-r-[6px] bg-[#ffebf5] border-[#C586A5]"
